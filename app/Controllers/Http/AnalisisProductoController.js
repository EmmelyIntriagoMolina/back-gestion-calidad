...
class AnalisisProductoController {
    ...
    async guardarAnalisisProducto({request,params,response}){
        try {
            ...
            let porc1 = request.input('porc1');
            let porc2 = request.input('porc2');
            let porc3 = request.input('porc3');
            let porc4 = request.input('porc4');
            let porc5 = request.input('porc5');
            let porc6 = request.input('porc6');
            let porc7 = request.input('porc7');
            let porc8 = request.input('porc8');
            let porc9 = request.input('porc9');
            let porc10 = request.input('porc10');
            let porc11 = request.input('porc11');
            let porc12 = request.input('porc12');
            let porc13 = request.input('porc13');
            let porc14 = request.input('porc14');
            let porc15 = request.input('porc15');
            let porc16 = request.input('porc16');
            let porc17 = request.input('porc17');
            let porc18 = request.input('porc18');
            let porc19 = request.input('porc19');
            let porc20 = request.input('porc20');
            let porc21 = request.input('porc21');
            let porc22 = request.input('porc22');
            let porc23 = request.input('porc23');
            let porc24 = request.input('porc24');
            let porc25 = request.input('porc25');
            let porc26 = request.input('porc26');
            let porc27 = request.input('porc27');
            let porc28 = request.input('porc28');
            let porc29 = request.input('porc29');
            let porc30 = request.input('porc30');
            let porc31 = request.input('porc31');
            let porc32 = request.input('porc32');
            let porc33 = request.input('porc33');

            
          
            const analisisCalidad = await Database.raw("insert into analisisproducto (producto, totalCamarones, observacion, color, olor, sabor, temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp9, temp10, pesoMuestra, numeroCamaronesAO, grsPromedio, otros100ppm, otros10ppm, deshidratadoUni, deshidratadosPorc, blandosUni, blandosPorc, mudadosUni, mudadosPorc, cabezaBajaUni, cabezaBajaPorc, cabezaNegraUni, cabezaNegraPorc, cabezaRojaUni, cabezaRojaPorc, hepReventadoUni, hepReventadoPorc,  membranaRotaUni, membranaRotaPorc, primerSegmentoUni, primerSegmentoPorc, necrosisLeveUni, necrosisLevePorc, necrosisFuerteUni, necrosisFuertePorc, melanosisUni, melanosisPorc, quebradosUni, quebradosPorc, deformesUni, deformesPorc, corbataUni, corbataPorc, pataUni, pataPorc, cascarasUni, cascarasPorc, antenasUni, antenasPorc, deterioroRUni, deterioroRPorc, totalAnalisisDef, ncamarones215, ncamarones205, ncamarones202, ncamarones195, ncamarones189, ncamarones182, ncamarones176, ncamarones169, ncamarones163, ncamarones155, ncamarones15, ncamarones143, ncamarones137, ncamarones13, ncamarones124, ncamarones117, ncamarones111, ncamarones104, ncamarones96, ncamarones91, ncamarones85, ncamarones78, ncamarones72, ncamarones65, ncamarones59, ncamarones52, ncamarones46, ncamarones33, ncamarones26, ncamarones2, ncamarones133, ncamarones07, ncamarones39, pesoT215, pesoT205, pesoT202, pesoT195, pesoT189, pesoT182, pesoT176, pesoT169, pesoT163, pesoT155, pesoT15, pesoT143, pesoT137, pesoT13, pesoT124, pesoT117, pesoT111, pesoT104, pesoT96, pesoT91, pesoT85, pesoT78, pesoT72, pesoT65, pesoT59, pesoT52, pesoT46, pesoT33, pesoT26, pesoT2, pesoT133, pesoT07, pesoT39, porc1, porc2,porc3,porc4,porc5,porc6,porc7,porc8,porc9,porc10,porc11,porc12,porc13,porc14,porc15,porc16,porc17,porc18,porc19,porc20,porc21,porc22,porc23,porc24,porc25,porc26,porc27,porc28,porc29,porc30,porc31,porcc32,porc33) values ('"+producto+"', '"+totalCamarones+"', '"+observacion+"', '"+color+"', '"+olor+"', '"+sabor+"', '"+temp1+"', '"+temp2+"', '"+temp3+"', '"+temp4+"', '"+temp5+"', '"+temp6+"', '"+temp7+"', '"+temp8+"', '"+temp9+"', '"+temp10+"', '"+pesoMuestra+"', '"+numeroCamaronesAO+"', '"+grsPromedio+"', '"+otros100ppm+"', '"+otros10ppm+"', '"+deshidratadoUni+"', '"+deshidratadosPorc+"', '"+blandosUni+"', '"+blandosPorc+"', '"+mudadosUni+"', '"+mudadosPorc+"', '"+cabezaBajaUni+"', '"+cabezaBajaPorc+"', '"+cabezaNegraUni+"', '"+cabezaNegraPorc+"', '"+cabezaRojaUni+"', '"+cabezaRojaPorc+"', '"+hepReventadoUni+"', '"+hepReventadoPorc+"', '"+membranaRotaUni+"', '"+membranaRotaPorc+"', '"+primerSegmentoUni+"', '"+primerSegmentoPorc+"', '"+necrosisLeveUni+"', '"+necrosisLevePorc+"', '"+necrosisFuerteUni+"', '"+necrosisFuertePorc+"', '"+melanosisUni+"', '"+melanosisPorc+"', '"+quebradosUni+"', '"+quebradosPorc+"', '"+deformesUni+"', '"+deformesPorc+"', '"+corbataUni+"', '"+corbataPorc+"', '"+pataUni+"', '"+pataPorc+"', '"+cascarasUni+"', '"+cascarasPorc+"', '"+antenasUni+"', '"+antenasPorc+"', '"+deterioroRUni+"', '"+deterioroRPorc+"', '"+totalAnalisisDef+"', '"+ncamarones215+"', '"+ncamarones205+"', '"+ncamarones202+"', '"+ncamarones195+"', '"+ncamarones189+"', '"+ncamarones182+"', '"+ncamarones176+"', '"+ncamarones169+"', '"+ncamarones163+"', '"+ncamarones155+"', '"+ncamarones15+"', '"+ncamarones143+"', '"+ncamarones137+"', '"+ncamarones13+"', '"+ncamarones124+"', '"+ncamarones117+"', '"+ncamarones111+"', '"+ncamarones104+"', '"+ncamarones96+"', '"+ncamarones91+"','"+ncamarones85+"', '"+ncamarones78+"', '"+ncamarones72+"', '"+ncamarones65+"', '"+ncamarones59+"', '"+ncamarones52+"', '"+ncamarones46+"', '"+ncamarones33+"', '"+ncamarones26+"', '"+ncamarones2+"', '"+ncamarones133+"','"+ncamarones07+"', '"+ncamarones39+"', '"+pesoT215+"', '"+pesoT205+"', '"+pesoT202+"', '"+pesoT195+"', '"+pesoT189+"', '"+pesoT182+"', '"+pesoT176+"', '"+pesoT169+"', '"+pesoT163+"', '"+pesoT155+"', '"+pesoT15+"', '"+pesoT143+"', '"+pesoT137+"', '"+pesoT13+"', '"+pesoT124+"', '"+pesoT117+"', '"+pesoT111+"', '"+pesoT104+"', '"+pesoT96+"', '"+pesoT91+"', '"+pesoT85+"', '"+pesoT78+"', '"+pesoT72+"', '"+pesoT65+"', '"+pesoT59+"', '"+pesoT52+"', '"+pesoT46+"', '"+pesoT33+"', '"+pesoT26+"', '"+pesoT2+"', '"+pesoT133+"', '"+pesoT07+"', '"+pesoT39+"',  '"+porc1+"', '"+porc2+"','"+porc3+"','"+porc4+"','"+porc5+"','"+porc6+"','"+porc7+"','"+porc8+"','"+porc9+"','"+porc10+"','"+porc11+"','"+porc12+"','"+porc13+"','"+porc14+"','"+porc15+"','"+porc16+"','"+porc17+"','"+porc18+"','"+porc19+"','"+porc20+"','"+porc21+"','"+porc22+"','"+porc23+"','"+porc24+"','"+porc25+"','"+porc26+"','"+porc27+"','"+porc28+"','"+porc29+"','"+porc30+"','"+porc31+"','"+porc32+"','"+porc33+"')")
